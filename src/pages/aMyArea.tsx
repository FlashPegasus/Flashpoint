                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-outfit mb-4 flex items-center gap-2">
                            <ShieldIcon size={20} className="text-accent-primary" /> Organizando
                        </h2>
                        <div className="flex flex-col gap-4">
                            {myTournaments.length === 0 ? (
                                <div className="glass-card p-10 text-center border-dashed border-2 border-white/5 group hover:border-purple/30 transition-all">
                                    <div className="w-16 h-16 bg-accent-bg-glass rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                                    ...
                                    <Link key={t.id} to={`/tournament/${t.id}`}>
                                        <div className="glass-card p-5 hover:border-purple/50 transition-all group">
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <h3 className="text-lg font-bold group-hover:text-accent-primary transition-colors">{t.name}</h3>
                    ...
                    <div>
                        <h2 className="text-2xl font-outfit mb-4 flex items-center gap-2">
                            <Trophy size={20} className="text-blue-400" /> Participando
                        </h2>
                        <div className="flex flex-col gap-4">

...
const Profile: React.FC = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            // Always set cloud storage as default now
            firestoreAdapter.setUserId(user.id);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-12">
                ...
                <div className="lg:col-span-1 space-y-4">
                    <div className="glass card p-6 text-center animate-fade-in">
                        ...
                        <h2 className="text-2xl font-bold mb-1">{isGuest ? '👤 Convidado' : user.name}</h2>
                    ...
                    {upgradeSuccess && (
                        <div className="glass border border-green-500/30 bg-green-500/5 p-5 rounded-2xl">
                            <p className="text-green-400 font-bold text-sm text-center">✓ Conta criada com sucesso!</p>
                        </div>
                    )}
                </div>

                    ...
                    <div className="space-y-6 animate-slide-up">
                        ...
                        <Section icon={<Lock size={20} />} title="Como usamos seus dados">
                            <ul className="space-y-2 text-secondary text-sm leading-relaxed">
                                <li>✅ Exibir seu perfil e estatísticas dentro do aplicativo</li>
                                <li>✅ Gerenciar sua participação em torneios</li>
                                <li>✅ Sincronizar seus dados entre dispositivos (quando a sincronização em nuvem está ativada)</li>
